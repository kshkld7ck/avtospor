                ...
                if(rawFile.readyState === 4)
                {
                    if(rawFile.status === 200 || rawFile.status == 0)
                    {
                        ...
                        $.ajax({
                         ...
                         var linka = document.getElementById("doc1");
                         linka.setAttribute('download', 'doc.pdf');
                         linka.href = "doc.pdf";
                    }
                }
            }
                ...
                if(rawFile.readyState === 4)
                {
                    if(rawFile.status === 200 || rawFile.status == 0)
                    {
                        ...
                        $.ajax({
                         ...
                         var linka = document.getElementById("doc2");
                         linka.setAttribute('download', 'doc.pdf');
                         linka.href = "doc.pdf";
                    }
                }
                ...
                if(rawFile.readyState === 4)
                {
                    if(rawFile.status === 200 || rawFile.status == 0)
                    {
                        ...
                        $.ajax({
                         ...
                         var linka = document.getElementById("doc3");
                         linka.setAttribute('download', 'doc.pdf');
                         linka.href = "doc.pdf";
                    }
                }
            ...
            rawFile.onreadystatechange = function ()
            {
                if(rawFile.readyState === 4)
                {
                    if(rawFile.status === 200 || rawFile.status == 0)
                    {
                        ...
                        doc = doc.replace(/\$RAYON/g, data.rayon);
                        doc = doc.replace(/\$NUMTS/g, data.numTS);
                        doc = doc.replace(/\$PHONE/g, data.phone);
                        doc = doc.replace(/\$ADRESS/g, data.adress);
                        doc = doc.replace(/\$EMAIL/g, data.email);
                        ...
                        var linka = document.getElementById("doc4");
                         linka.setAttribute('download', 'doc.pdf');
                         linka.href = "doc.pdf";
                    }
                }
            ...
            rawFile.onreadystatechange = function ()
            {
                if(rawFile.readyState === 4)
                {
                    if(rawFile.status === 200 || rawFile.status == 0)
                    {
                        ...
                        var linka = document.getElementById("doc5");
                         linka.setAttribute('download', 'doc.pdf');
                         linka.href = "doc.pdf";
                    }
                }
            ...
            rawFile.onreadystatechange = function ()
            {
                if(rawFile.readyState === 4)
                {
                    if(rawFile.status === 200 || rawFile.status == 0)
                    {
                        ...
                        doc = doc.replace(/\$MODEL/g, data.model);
                        doc = doc.replace(/\$SUM/g, data.sum+" рублей");
                        doc = doc.replace(/\$PHOTONOMER/g, data.photonomer);
                        ...
                        var linka = document.getElementById("doc6");
                         linka.setAttribute('download', 'doc.pdf');
                         linka.href = "doc.pdf";
                    }
                }
            ...
            rawFile.onreadystatechange = function ()
            {
                if(rawFile.readyState === 4)
                {
                    if(rawFile.status === 200 || rawFile.status == 0)
                    {
                        ...
                        var linka = document.getElementById("doc7");
                         linka.setAttribute('download', 'doc.pdf');
                         linka.href = "doc.pdf";
                    }
                }
            ...
            rawFile.onreadystatechange = function ()
            {
                if(rawFile.readyState === 4)
                {
                    if(rawFile.status === 200 || rawFile.status == 0)
                    {
                        ...
                        var linka = document.getElementById("doc8");
                         linka.setAttribute('download', 'doc.pdf');
                         linka.href = "doc.pdf";
                    }
                }
            ...
            rawFile.onreadystatechange = function ()
            {
                if(rawFile.readyState === 4)
                {
                    if(rawFile.status === 200 || rawFile.status == 0)
                    {
                        ...
                        doc = doc.replace(/\$SPIDFROM/g, data.spidfrom);
                        doc = doc.replace(/\$SPIDTO/g, data.spidto);
                        doc = doc.replace(/\$SPIDOSER/g, data.spidoser);
                        doc = doc.replace(/\$SPIDONUM/g, data.spidonum);
                        doc = doc.replace(/\$NUMTS/g, data.numTS);
                        doc = doc.replace(/\$PHONE/g, data.phone);
                        doc = doc.replace(/\$ADRESS/g, data.adress);
                        doc = doc.replace(/\$EMAIL/g, data.email);
                        ...
                        var linka = document.getElementById("doc9");
                         linka.setAttribute('download', 'doc.pdf');
                         linka.href = "doc.pdf";
                    }
                }
