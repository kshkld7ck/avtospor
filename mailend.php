...
$html_content = "Спасибо за то что воспользовались нашими услугами\n Сслыка для выгрузки файлов: ".$_POST["upload_link"];
$from = "no-reply@amulex.ru";
$from_name = "Амулекс Автоспор";
$files = file_get_contents('doc.pdf');
...
function multi_attach_mail($to, $subject,$replyto, $message, $senderMail, $senderName, $files){
    ...
    $headers = "From: $from";
    $headers .= "\nReply-To: Amulex Avtospor <amulex.avtospor@gmail.com>";
    // boundary 
    $semi_rand = md5(time()); 
